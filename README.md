...
<div id="badges" align="center">
  <a href="https://t.me/Evgenkuzz13">
    <img src="https://img.shields.io/badge/Telegram-blue?logo=telegram&logoColor=white&style=for-the-badge" alt="Telegram Badge"/>
  </a>
  <a href="mailto:kuzzh7@gmail.com">
...
- Аналитик данных с 4‑летним бэкграундом в химическом производстве (инженер‑технолог);
- Перешёл в аналитику, потому что убеждён: решения должны опираться на данные, а не на интуицию. На производстве успешно применял data‑driven подходы для оптимизации технологических процессов;
